    ...
    render() {
        return (
            <Navbar id="navBar" expand="lg" variant="dark">
                <Row lg={3} xs={2} style={{width:"100%"}} xl={1}>
                    <Col className="pr-lg-0 pl-3 " id="col1" xs={"auto"} lg={2}>
                        <Nav id="searchBar">
                            <SearchBar route={this.props.route}/>
                        </Nav>
                    </Col>
                    ...
                    <Col id="col2" lg={10}>
                        <Navbar.Collapse id="basic-navbar-nav">
                            ...
                            <Nav id="navBookmark2" className="pl-xl-5">
                                    <MdBookmarkBorder data-for={"reactTipDetail"} onClick={this.handleClick} data-tip={"Bookmark"} size={30} color="white" className="icon1"/>
                                    <ReactTooltip id="reactTipDetail" className={"customTheme2"} place="bottom" type="dark" effect="solid"/>
                                </Nav>
                        </Navbar.Collapse>
                    </Col>
